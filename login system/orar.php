...
<body>
    ...
    <div class="container">
        <a href="add_pozitie.php" class="btn btn-dark mb-3">Adauga pozitie</a>
                    ...
                    while ($row = mysqli_fetch_assoc($result)){
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="edit_pozitie.php?id=<?php echo $row['id'] ?>" class="link-dark"><span class="btn btn-dark mr-1">Editeaza</span></a>
                                    <a href="del_pozitie.php?id=<?php echo $row['id'] ?>" class="link-dark"><span class="btn btn-dark mr-1">Sterge</span></a>
                                </td>
                            </tr>
                        <?php
                    }
