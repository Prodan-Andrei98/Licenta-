...
if(isset($_POST['submit'])){
   ...
   $sql= "INSERT INTO `orar`(`id`, `ziua`, `ora`,`locatie`,`sport`,`prof`) VALUES (NULL,' $ziua','$ora','$locatie','$sport','$prof')";
...
<body>
   <nav class="navbar navbar-light justify-content-center fs-3 mb-5" style="background-color: blueviolet; color:white;">Adauga pozitie</nav>

   <div class="container">
      <div class="text-center mb-4">
         <p class="text-muted">Completeaza spatiile de mai jos pentru a adauga o pozitie noua</p>
      </div>
